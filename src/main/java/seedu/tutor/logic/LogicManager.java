...
import seedu.tutor.logic.parser.TutorMapParser;
import seedu.tutor.logic.parser.exceptions.ParseException;
import seedu.tutor.model.Model;
import seedu.tutor.model.ReadOnlyTutorMap;
import seedu.tutor.model.person.Person;
import seedu.tutor.storage.Storage;
...
public class LogicManager implements Logic {
    ...
    private final TutorMapParser tutorMapParser;
    ...
    public LogicManager(Model model, Storage storage) {
        ...
        tutorMapParser = new TutorMapParser();
    }
    ...
    public CommandResult execute(String commandText) throws CommandException, ParseException {
        ...
        Command command = tutorMapParser.parseCommand(commandText);
        commandResult = command.execute(model);

        try {
             storage.saveTutorMap(model.getTutorMap());
    ...
    public Path getTutorMapFilePath() {
        return model.getTutorMapFilePath();
    }
